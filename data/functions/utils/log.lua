...
local FUNCTION_FORMAT = "[PACKAGE-> %s ][FUN-> %s ] [ %s ] "
local PARAM_FORMAT = "[%s-> %s] "
local LOG_STR = "%s %s"
...
function paramFormat( ... )
	...
	for k,v in pairs(arg) do
		local ret = format(PARAM_FORMAT, k, tostring(v))
